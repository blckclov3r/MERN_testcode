                    ...
                    <Box sx={style}>
                        ...
                        <form onSubmit={props.handleSubmit}>
                            <TextField
                                ...
                                margin="normal"
                                size="small"
                                InputLabelProps={{shrink: (!!props.name || props.dataClient?.client.name) as boolean}}
                            />
                            <TextField
                                label="Email"
                                variant="outlined"
                                ...
                                InputLabelProps={{shrink: (!!props.email || props.dataClient?.client.email) as boolean}}
                            />
                            <TextField
                                label="Phone"
                                variant="outlined"
                                ...
                                InputLabelProps={{shrink: (!!props.phone || props.dataClient?.client.phone) as boolean}}
                            />
